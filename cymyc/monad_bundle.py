...
class HYM_MonadBundle:
    def __init__(self, key, monad_bundle, metric_fn, tx: optax.GradientTransformation, 
                 n_units: List[int] = [48, 48, 48, 48], name = None):

        self.monad = monad_bundle
    ...
    def __call__(self, p, params):
        # return Hermitian bundle metric H
        return self.monad.section_metric_network(p, params)
